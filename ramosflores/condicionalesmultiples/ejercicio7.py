...
# verificador
comprador_compulsivo=(monto_total>50)
...
if(comprador_compulsivo<30):
    print("GRACIAS POR SU COMPRA,VUELVA PRONTO")
if(comprador_compulsivo<48):
    print(" SI LLEGABAS A 50 SOLES DE COMPRA TE HUBIERAS GANADO UN 10% DE DESCUENTO ")