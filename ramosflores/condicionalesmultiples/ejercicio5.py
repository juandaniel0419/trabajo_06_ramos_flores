...
if(comprador_compulsivo>240):
    print("GRACIAS POR SU COMPRA QUE TENGA UN BUEN DIA")
if(comprador_compulsivo<1900):
    print("ESTUVO A PUNTO DE GANAR UN DESCUENTO EN SU PROXIMA COMPRA")
